...
class StatelessWidgets extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new StatelessSample(),
    );
  }
}

class StatelessSample extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return new StatelessTest();
  }

}

class StatelessTest extends State<StatelessSample> {
  @override
  Widget build(BuildContext context) {
    ...
    return new Container(
      ...
      child: new Card(
        child: new Container(
          ...
          child: new Column(
            children: <Widget>[this.title, new Padding(padding: new EdgeInsets.all(10)), this.icon],
          ),
        ),
      ),
    );
